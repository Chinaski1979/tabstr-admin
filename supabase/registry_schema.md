...
- `subscription_plans`: `id`, `plan_name`, `features` (`text[]`, marketing bullets), …
- `subscription_plan_prices`: `plan_id`, `billing_interval`, `plan_price`, `is_active`, …
- `organization_special_plans`: `organization_registry_id`, `special_plan_name`, `special_price`, `is_active`, `features` (`text[]`), …
